...
import FormularioTurno from "../formularioturno/FormularioTurno";
        ...
        <Row>
          <Col md={6}>
            ...
            <p style={{ color: "#000000", fontSize: "1rem" }}>
              Nuestras consultas veterinarias incluyen un examen físico
              completo, evaluación del historial médico, revisión de peso y
              condición corporal, revisión de oídos, ojos y dientes, y
              recomendaciones personalizadas para el cuidado de tu mascota.
              Nuestros veterinarios experimentados utilizan equipos modernos
          ...
          <Col md={6}>
            <div className="p-3 h-100 w-100 rounded shadow-sm">
              <FormularioTurno serviceId={servicio._id} />
            </div>
          </Col>
        </Row>
      </Modal.Body>
