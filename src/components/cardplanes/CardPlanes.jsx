...
const Planes = () => {
  ...
  return (
    <Container className="my-5">
      <h2 className="mb-4 text-center text-success fw-bold">Planes Disponibles</h2>
      <Row xs={1} sm={2} md={3} className="g-4">
        {planes.map(({ _id, nombre, descripcion, precio, servicios, imagen }) => (
          <Col key={_id}>
            <Card className="shadow-sm h-100 border-success">
              ...
              <Card.Body className="d-flex flex-column">
                <Card.Title className="text-success fw-bold fs-4 mb-2">{nombre}</Card.Title>
                ...
                <Link to={`/contratar-plan/${_id}`} className="btn btn-success mt-auto">
                  Ver Más
                </Link>
              </Card.Body>
            </Card>
